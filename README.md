...
**onedrive-cf-index-CN** 是支持世纪互联、采用 `cf worker` 做后端的  `OneDrive` 索引程序。Fork 自 [onedrive-cf-index](https://github.com/spencerwooo/onedrive-cf-index)，只稍加修改,在此感谢🍻   **源库已支持世纪互联，所以把此文档留作一个简陋的中文指示，希望能帮助到大家**
