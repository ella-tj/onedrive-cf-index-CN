...
export async function getAccessToken() {
  ...
  const resp = await fetch(config.useOnedriveCN && 'https://login.microsoftonline.com/common/oauth2/v2.0/token' || 'https://login.microsoftonline.com/common/oauth2/v2.0/token', {
    method: 'POST',
